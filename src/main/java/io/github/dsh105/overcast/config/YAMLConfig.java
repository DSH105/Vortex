package io.github.dsh105.overcast.config;
...
public class YAMLConfig {
    ...
    private Overcast plugin;

    public YAMLConfig(InputStream configStream, File configFile, int comments, Overcast plugin) {
